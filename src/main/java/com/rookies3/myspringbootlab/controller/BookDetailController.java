...
public class BookDetailController {
    ...
    public ResponseEntity<List<BookDTO.Response>> getAllBooks() {
        List<BookDTO.Response> bookResponseList = bookService.getAllBooks();
    ...
    public ResponseEntity<List<BookDTO.Response>> getBooksByAuthor(@RequestParam String author){
        List<BookDTO.Response> authorBookList = bookService.getBooksByAuthor(author);
    ...
    public ResponseEntity<List<BookDTO.Response>> getBooksByTitle(@RequestParam String title){
        List<BookDTO.Response> titleBookList = bookService.getBooksByTitle(title);
        return ResponseEntity.ok(titleBookList);
    }
